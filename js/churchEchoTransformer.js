async function churchEchoTransformer(audioBuffer, opts) {
  ...
  convolver.buffer = await ctx.decodeAudioData(await (await fetch("/voicemaker/audio/impulse-responses/church.wav")).arrayBuffer());
