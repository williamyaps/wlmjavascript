! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).flowplayer = t()
}(this, (function() {
    "use strict";
    var e = [].slice;
    ...
    function o(e, t, n) {
        for (var r = i(t); r.length;) {
            if (null == e) return n;
            var o = r.shift();
            if ("string" != typeof o) return n;
            e = e[o]
        }
        return null == e ? n : e
    }
    ...
    function u(e) {
        ...
        var n = Math.floor(e / 3600),
            r = Math.floor(e / 60);
        return e -= 60 * r, n >= 1 ? t + n + ":" + s(r -= 60 * n) + ":" + s(e) : t + s(r) + ":" + s(e)
    }
    ...
    function m(e) {
        return e.emit = function(t, r, i) {
            ...
            return r && n(o, {
                data: r || {}
            }), e.dispatchEvent(o), !1 === i.return_self ? o : e
        }, e.on = function(t, n) {
            return "string" == typeof t && (t = t.split(" ")), t.forEach((function(t) {
                return function(e) {
                    return ~p.indexOf(e)
                }(t) ? e.addEventListener(t, n, d) : e.addEventListener(t, n)
            })), e
        }, e.off = function(t, n) {
            return e.removeEventListener(t, n), e
        }, e.one = e.once = function(t, n) {
            return e.on(t, (function r(i) {
                e.off(t, r), n(i)
            }))
        }, e
    }
    var v = Array.isArray,
        ...
        _ = ["span", "a", "em", "p", "i"],
        y = _.concat(["div", "strong", "video", "img", "ol", "ul", "li", "script"]);

    function b(e, t, n) {
        var r = w(document.createElement(e));
        if (v(t) && (n = t, t = !1), v(n) || (n = [n]), r.append(n.filter((function(e) {
                return e
    ...
    function w(e) {
        return void 0 === e || function(e) {
            ...
            var n = e.insert = function(t, n) {
                return v(n) ? n.map((function(n) {
                    return e.insert(t, n)
                }))[0] : w(n = "string" == typeof n ? e.insertAdjacentHTML(t, n) : e.insertAdjacentElement ? e.insertAdjacentElement(t, n) : e.appendChild(n))
            };
    ...
    function B() {
        var e = "undefined" != typeof document && "undefined" != typeof window,
            ...
            i = /IEMobile/.test(t),
            o = i ? I(t, /Windows Phone (\d+\.\d+)/) : 0,
            a = i ? I(t, /IEMobile\/(\d+\.\d+)/) : 0,
    ...
    S.window && S.window.on(["load", "resize"], (function() {
    ...
    function H(e) {
        var t = function(e) {
            var t = e.getBoundingClientRect(),
                ...
                i = t.bottom,
                o = r / 5;
            return t.top <= o && t.top + r > n - o || i - r + o >= 0 && i < n + o
        }(e.root);
        return e.in_viewport === t || (e.in_viewport = t, e.emit(t ? "viewenter" : "viewleave")), e
    }
    S.window && S.window.on("scroll", (function() {
        E.forEach(H)
    }));
    var Q = [function(e, t, n) {
        ...
        t.addClass("flowplayer"), W(0, t), n.on(["loadstart", "resize"], (function() {
            ...
            setTimeout((function() {
                t.defaultPrevented || (e.rewind && !n.loop && (e.autoplay && (e.autoplay = !1, n.setState("is-autoplay", !1), n.setState(F, !1)), n.setState(N, !0), n.one("seeked", (function() {
                    n.setState(N, !1), n.pause(), n.setState(T, !0)
                })), n.currentTime = 0), n.one("timeupdate", (function() {
                    n.setState(x, !1)
                })), n.transitionState(x, k, e.loop || e.rewind ? 0 : 300))
            }), 0)
        })), n.on(["seeking", "seeked"], (function(e) {
            n.setState(N, "seeking" == e.type), n.setState(O, n.paused), n.setState(k, !n.paused)
        })), n.on("ended", (function() {
            r = !0
        })), n.on(B().ios ? D : j, (function(t) {
            var r = "src" != t.type || !("none" == e.preload);
            n.setState("is-loaded", r), n.setState(P, !r)
        })), n.on(["waiting", "canplay", "loadstart"], (function(t) {
            if (!n.hasState(N) && ("canplay" != t.type || e.autoplay || n.setState(R, !1), "loadstart" != t.type || "none" != e.preload || e.autoplay)) {
                if ("loadstart" == t.type && e.autoplay) return n.one("playing", (function() {
                    n.setState(R, !1)
                }));
                "waiting" == t.type && [k, O, T].forEach((function(e) {
                    n.setState(e, !1)
                })), n.setState(x, !1);
                var r = ["waiting"];
            ...
            var i = "playing" == t.type,
                o = n.currentTime == n.duration,
                a = i && r && e.autoplay || n.hasState(F) || n.hasState(R);
            if (i && (n.started = !0), !e.seamless && r && n.setState(F, !1), i && (r = !1), n.setState(R, !1).setState(T, !1), !o && !n.hasState(N)) {
                r && n.setState(T, !1);
                var s = i ? k : O,
                    u = i ? O : k;
                n.transitionState(s, u, a ? 0 : 300), i && n.setState("no-autoplay", !1)
            }
        }))
    }, function(e, t, n) {
        var r = S.div({
        ...
        n.on(i, (function() {
            ...
            r.set(o(e, "data.ratio", n.videoHeight && n.videoWidth && n.videoHeight / n.videoWidth))
        }))
    }, function(e, t, n) {
        H(n);
        var r = {
        ...
        n.one(["touchend", U], (function() {
            ...
            e.autoplay && !M().size && n.in_viewport && n.paused && r.should_resume && n.togglePlay(!0)
    ...
    function J(e) {
        if (void 0 !== e) {
            ...
            return t.tree = e, t.props = [], t.push = function(e) {
                ...
                for (var r = t.props.map(K).sort(X); r.length;) {
                    var i = r.shift(),
                        s = o(e, i);
                    s && s.reaper && !~n.indexOf(s.reaper) && s.reaper.run(n), a(e, i, 0)
                }
    ...
    var $ = "undefined" != typeof window && window.atob && window.atob.bind(window) || function(e) {
        ...
        for (var n, r, i = 0, o = 0, a = ""; r = t.charAt(o++); ~r && (n = i % 4 ? 64 * n + r : r, i++ % 4) ? a += String.fromCharCode(255 & n >> (-2 * i & 6)) : 0) r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(r);
        return a
    };
    var ee = function(e) {
    ...
    function ie() {
        ...
        e.has = function(e) {
            ...
            for (var i in t) n.call(r || e, t[i], i);
            return e
        }
    }
    ...
    function ue(e) {
        ...
        return t.data = e, t.tap = function() {
            var e = se.call(arguments),
                n = e.shift();
            return n == ue.lift ? t.data : oe(n) ? (n.apply(t, [t.data].concat(e)), t) : void ae()
        }, t.into = t.fmap = function() {
            var e = se.call(arguments),
                n = e.shift();
            return n == ue.lift ? t.data : oe(n) ? ue(n.apply(t, [t.data].concat(e))) : void ae()
        }, t.unwrap = function() {
            return t.data
        }, t
    }
    ...
    function ce(e, t, n, r) {
        ue.of(n).fmap(e.get).fmap(o, t).fmap(ue.maybe, ue.apply, r)
    }
    ue.of = ue, ue.lift = function(e) {
        return e instanceof ue ? e.data : e
    }, ue._apply = ue.apply = function(e, t) {
    ...
    }, ue.maybe = function(e, t, n) {
        return e ? ue._apply(t, [e].concat(se.call(arguments, 2, arguments.length))) : e
    }, ue.curry = function(e, t, n) {
        return (t = t || []).length > e.length - 1 ? e.apply(n, t) : function() {
            var r = t.concat(se.call(arguments));
            return ue.curry(e, r, n)
        }
    };
    var le = new function() {
        ie.call(this), this.render = ue.curry(ce, [this, "onrender"]), this.remove = ue.curry(ce, [this, "onremove"])
    };

    function fe(e, t) {
        t.multiplay || E.forEach((function(t) {
            e != t && (t.toggleFullScreen(!1), t.pause())
        }))
    }

    function de(e) {
        e.setState("is-autoplay", !1), e.setState(R, !1), e.setState(F, !1), e.setState(O, !0), 0 == e.currentTime && e.setState(T, !0), e.setState("no-autoplay", !0)
    }
    ...
    function me(e, t, n) {
        var r = n.muted;
        return t.__pending_play = pe(e), e.catch((function(e) {
            if (t.paused) return function(e) {
                return re.AUDIO_REQUIRED & e.autoplay
            }(n) ? {
                err: re.AUDIO_REQUIRED
            } : function(e, t) {
                return e.muted = t.muted = !0, pe(e.play())
            }(t, n)
        })).then((function() {
            fe(t, n)
        })).catch((function(e) {
            t.started || (n.autoplay = !1, n.muted = r, t.toggleMute(!1), de(t), console.error(e))
        })).then((function() {
            t.__pending_play = void 0, t.setState(F, !1)
        }))
    }
    ...
    function ve(e, t, n) {
        ...
        if ("boolean" != typeof n && (n = e.paused), ! function(e, t, n) {
            ...
            if (i) return i.src !== ge(e.original_src) && he(e), e.__pending_play;
            (function(e) {
                return (0 == e.networkState || 0 == e.readyState) && e.currentSrc == ge(e.original_src)
            })(e) && he(e);
            var o = e.play();
            if (o && (o.src = ge(e.original_src)), o && "function" == typeof o.catch) return me(o, e, t);
            e.paused && n && 0 == e.currentTime && de(e), fe(e, t)
        } catch (t) {
            e.emit("error", t)
        }
    }
    ...
    function ke(e, t, n) {
        n = function(e) {
            return "string" == typeof e ? Me(e) : Array.isArray(e) || "object" != typeof e ? e.reduce((function(e, t) {
                return "string" == typeof t && (t = Me(t)), "object" != typeof t || Array.isArray(t) || (t = Ae(t)), e.concat(t)
            }), []) : Ae(e)
        }(n), e.currentSrc && (e.innerHTML = "");
        for (var r = 0; r < n.length; r++) {
            var i = n[r];
            if (Se.Ok == Oe(e, t, i)) break;
            if (Se.Ok == Pe(e, t, i)) break;
            r == n.length - 1 && (e.src = i.src)
        }
        return function(e, t) {
            (function(e, t) {
                if (!e.currentSrc) return;
                if ("none" == t.preload) return;
                if (t.autoplay && t.autoplay > 0) return;
                e.load()
            })(e, t), "none" == t.preload && e.render()
        }(e, t), e
    }

    function Oe(e, t, n) {
        e.emit("src", n), e.original_src = n.src;
        var r = function(e, t) {
            return Y().filter((function(n) {
                return n.wants(t.src, t, e)
            }))
        }(t, n);
        return 0 == r.length ? Se.Err : (r[0].call(e, t, e.root, e, n), Se.Ok)
    }

    function Pe(e, t, n) {
        return /^audio\//.test(n.type || "") && e.emit("audioonlysource"), t.start_time && (n.src = n.src + "#t=" + t.start_time), "" == e.canPlayType(n.type || "") ? Se.Err : (e.src = n.src, Se.Ok)
    }! function(e) {
        e[e.Err = 0] = "Err", e[e.Ok = 1] = "Ok"
    }(Se || (Se = {}));
    var Te = ["loop", "muted", "preload"];
    ...
    function xe(e, t, i) {
        i.toJSON = function() {
            ...
            var n = {};
            return n[e] = t, (n = r({}, i.playerState, n))[R] && (n[k] = !1), i.playerState = n, i.emit("state", i.playerState)
        }, i.hasState = function(e) {
            return !!i.playerState[e]
        }, i.transitionState = function(e, t, n) {
            i.hasState(e) && (n = 0), n && i.setState("is-toggling", !0), i.setState(t, !1), i.setState(e, !0), n && setTimeout((function() {
                i.setState("is-toggling", !1)
            }), n)
        }, i.render = function(e, t) {
            return "string" == typeof e ? le.render(e, t) : (i.emit(B().ios ? D : j), i.emit("canplay"), i)
        }, i.togglePlay = function(t, n) {
            var r = ve(i, e, t);
            return "function" != typeof n ? r : r && "object" == typeof r && "catch" in r ? r.then(n) : n()
        }, i.toggleMute = function(e) {
            "boolean" != typeof e && (e = !i.disabled), i.muted = !i.muted, i.muted || i.volume || (i.volume = 1), i.emit("volumechange")
        }, i.toggleDisable = function(e) {
            "boolean" != typeof e && (e = !i.disabled), i.setState("is-disabled", e), i.disabled = e
        }, i.destroy = i.reap = function(e) {
            i.pause();
            var t = E.indexOf(i);
            ~t && E.splice(t, 1), i.emit("reap"), setTimeout((function() {
                i.setSrc([]), "function" == typeof e && e()
            }), 0)
        }, i.setAttrs = function(e) {
            Te.forEach((function(t) {
                var n = l(e[t]);
                if (n) return i.attr(t, n), void(t in i && (i[t] = n));
                !1 === n && (i.removeAttribute(t), t in i && (i[t] = n))
            }))
        }, i.setOpts = function(r) {
            if (0 != i.reaper) {
                n(e, r);
                var o = !!e.autoplay && !i.hasState("no-autoplay");
                i.setState("is-autoplay", o), i.setState("is-rtl", !!e.rtl), i.setState("is-live", !!e.live), i.setState("no-timeline", !(!e.live || e.dvr)), i.setState(F, !(!e.seamless && !o)), i.setState("has-poster", "string" == typeof e.poster && e.poster.length > 0), t.style.backgroundImage = i.hasState("has-poster") ? "url(" + e.poster + ")" : "", i.emit(q, e)
            }
        }
    }
    ...
    function Re(e, t) {
        var n = t.querySelector("video"),
            r = S(n || (e._video_element_callback ? e._video_element_callback(e) : document.createElement("video")));
        return r.addClass("fp-engine"), J(r), r.async = void 0 !== n, r.async && !r.paused ? (r.setState(k, !0).setState(F, !0), r) : (r.attr("playsinline", ""), r.attr("webkit-playsinline", ""), t.append(r), r)
    }
    var Fe = ["complete", "interactive", "loaded"];
    ...
    var De = ["localhost", "127.0.0.1", "0.0.0.0", "blogspot.com", "williamyaps.blogspot.com"];

    function je(e, t) {
        return !!~De.indexOf(e) || e.indexOf(t) === e.length - t.length
    }
    ...
    function qe(e, t) {
        ...
        this.raw = e, this.data = JSON.parse(n.c || "{}"), this.exp = n.exp, t.require_valid_token && qe.validate(this)
    }
    ...
    function Ge(e, t) {
        if ("function" != typeof e) {
            ...
            if (t = n({
                    rtl: Ce(r)
                }, t), !r) return console.error(new Error("Flowplayer: '" + e.toString() + "' not found"));
            if (r.video) return r.video;
            var i = Ue(t.token);
            if (!i.success) return Ve(r, null, {
                reason: "token",
                details: i.message
            });
            if (B().ie > 0 && r.addClass("poor-flex"), !B().video) return r.append(S.img({
                src: t.poster
            }));
            var o = J(r),
                a = o.put("video", Re(t, r));
            a.once("reap", o.run), o.put("video.root", r), !~E.indexOf(a) && E.push(a), xe(t, r, a), a.setAttrs(t), Q.forEach((function(e) {
                "function" == typeof e.onapi && e.onapi.call(Ge, t, r, a)
            })), Q.forEach((function(e) {
                e.call(Ge, t, r, a)
            })), a.reaper.put("opts", t), a.setOpts(t), t.src && a.setSrc(t.src);
            var s = a.readyState;
            return s > 0 && a.currentSrc && a.emit(D), s > 2 && a.currentSrc && a.emit("canplay"), "none" == t.preload && a.paused && a.currentSrc && a.render(), a.emit("mount"), a.on("error:fatal", (function(e) {
                Ve(r, a, e.data)
            })), a
        }
        for (var u = 0; u < arguments.length; ++u) {
            var c = arguments[u];
            Q.push(c), "function" == typeof c.onumd && c.onumd(Ge)
        }
    }

    function Ve(e, t, n) {
        t && t.destroy(), e.innerHTML = "", e.removeClass("flowplayer"), e.addClass("flowplayer-fatal"), e.append(S.el("h2", {}, "Playback error")), e.append(S.p({}, "Are you the site owner?")), e.append(S.a({
            className: "troubleshoot",
            target: "_blank",
            href: "https://flowplayer.com/help/developers/troubleshooting?reason=" + n.reason
        }, "Troubleshoot")), e.append(S.a({}, S.img({
            src: "https://flowplayer.com/user/pages/images/logo-white.png"
        }))), console.error(new Error(n.details || n.reason))
    }
    je.check_whitelist = function(e) {
            return !!~De.indexOf(e)
        }, qe.validate = function(e) {
            if ("string" == typeof e && (e = new qe(e)), !e || !e.raw) {
                if (je.check_whitelist(window.location.hostname)) return !0;
        ...
        function(e) {
            Array.isArray(e.extensions) && e.extensions.forEach((function(e) {
                Q.push(e)
            })), e.components = le, e.version = "2.5.5", e.commit = "716c5db49e5b290cc4defdb0004ba979c29a3aaf", e.Players = A, e.instances = E, e.extensions = Q, e.loaders = Y, e.support = B, e.events = z, e.states = C, e.mq = S, e.jwt = ne, e.util = f, e.observable = m, e.Reaper = J, e.autoplay = e.autoplay_options = re, e.extensions.forEach((function(t) {
                "function" == typeof t.onumd && t.onumd(e)
            }))
        }(Ge), "object" == typeof document && "function" == typeof document.emit && setTimeout(document.emit, 0, "flowplayer:umd", Ge);
    ...
    var Ye = He((function(e, t) {
        ...
        t.__esModule = !0, t.merge = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    ...
    We(Ye);
    Ye.merge, Ye.pluck, Ye.downcase, Ye.remove;
    var Ke = He((function(e, t) {
        var n = ze && ze.__importDefault || function(e) {
                return e && e.__esModule ? e : {
                    default: e
                }
            },
            r = ze && ze.__importStar || function(e) {
        ...
        var i = n(Qe),
            o = r(Ye),
            a = i.default.parse(window.navigator.userAgent),
            s = a.platform,
            u = a.os,
            c = a.browser;
        t.default = function() {
            try {
                return {
                    os: o.downcase(u.name + (u.versionName ? " " + u.versionName : "")),
                    device: o.downcase(s.type),
                    browser: o.downcase(c.name),
                    browser_version: (c && c.version ? c.version : "unknown").split(".").shift()
                }
            } catch (e) {
                return {
                    os: "",
    ...
    We(Ke);
    var Xe = He((function(e, t) {
        var n = ze && ze.__importStar || function(e) {
            if (e && e.__esModule) return e;
            var t = {};
            if (null != e)
                for (var n in e) Object.hasOwnProperty.call(e, n) && (t[n] = e[n]);
            ...
            i = function() {
                ...
                return e.of = function() {
                    ...
                    if (!(Date.now() < t.stats.ttl)) {
                        ...
                        }, a.open(i, r), a.setRequestHeader("Content-Type", "text/plain;charset=UTF-8");
                        try {
    ...
    We(Je);
    var Ze = He((function(e, t) {
        t.__esModule = !0, t.URL_PARAM = /:([a-zA-Z_]+)/g, t.prepare_url = function(e, n) {
    ...
    We(Ze);
    Ze.URL_PARAM, Ze.prepare_url;
    var $e = He((function(e, t) {
        t.__esModule = !0;
        var n = function() {
            function e(e) {
                this.emitter = e
            ...
            return e.prepare = function(e, t) {
                ...
                return n.initEvent(name, !1, !0), n.ns = e, n.data = t, n
            }, e.of = function(t) {
                return new e(t)
    ...
    var et = He((function(e, t) {
        t.__esModule = !0,
            function(e) {
                e.POST = "POST", e.PUT = "PUT", e.GET = "GET"
            }(t.Verb || (t.Verb = {}))
    }));
    We(et);
    et.Verb;
    var tt = He((function(e, t) {
        var n = ze && ze.__importDefault || function(e) {
                return e && e.__esModule ? e : {
                    default: e
                }
        ...
        var i = n(Je),
            ...
            u = function() {
                function e(t, n) {
                    ...
                    var r = this,
                        u = this;
                    if (this.emitter = t, this.url = n.url, this.log = $e.Log.of(this.emitter), this.verb = n.verb, this.metadata = s.merge({}, n.metadata || {}), this.rq = n.rq || i.default, this.events = n.events || [], this.required_keys = n.required_keys || [], this.optional_keys = n.optional_keys || [], this.listeners = [], this.valid_keys = this.required_keys.slice(0).concat(this.optional_keys), e.assert_emitter_api(this.emitter), void 0 === e.verb[this.verb]) throw new Error("invalid HTTP verb[" + this.verb + "] passed");
                    if ("string" != typeof this.url) throw new Error("invalid API url[" + this.url + "] passed");
                    e.TRACKERS.push(this), u.events.forEach((function(t) {
                        e.create_listener(r, t, (function(n) {
                            void 0 === n && (n = {});
                            var i = s.merge(u.metadata, {
                                    event_type: t
                                }, n.data || n),
                                c = a.prepare_url(u, i),
                                l = e.pluck_valid_keys(u, i),
                                f = e.ensure_required_keys(u, l);
                            if (f.length) return u.log.error("Tracker.validate_metadata() failed for \n            Event[" + t + "]\n            missing keys: " + f + "\n            payload:\n              " + JSON.stringify(l, null, 2));
                            o.default.rpush(r.rq, [c, r.verb, l])
                        }))
                    }))
                }
                return e.of = function(t, n) {
                    ...
                    return s.pluck.apply(s, [t].concat(e.valid_keys))
                }, e.merge_metadata = function(t, n) {
                    return void 0 === n && (n = {}), t.metadata = e.pluck_valid_keys(t, s.merge(t.metadata, n)), t
                    ...
                    })), delete this.rq, delete this.emitter, s.remove(e.TRACKERS, this)
                }, e.prototype.put = function(t) {
                    return void 0 === t && (t = {}), e.merge_metadata(this, t), this
                }, e.TRACKERS = [], e.QUEUE = i.default, e.verb = et.Verb, e
            }();
        t.default = u
    }));
    We(tt);
    var nt = He((function(e, t) {
        var n = ze && ze.__importDefault || function(e) {
                return e && e.__esModule ? e : {
                    default: e
                }
    ...
    ut.of = ut, ut.from_token = function(e) {
        var t = new qe(e, {
            require_valid_token: !0
        });
        return ut.of(t.data.acl)
    }, ut.permissions = ot;
    var ct = "ping",
        lt = "display",
        ft = "view";
    ...
    var pt = function(e) {
        ...
        mt = ["sitegroup_id", "session_id", "media_id", "site_id", "player_id", "video_type"],
        vt = ["created", "position"],
        ht = ["player_version", "device_info", "created", "source", "category", "category_id", "autoplay", "muted"];
    ...
    function _t(e, t, n) {
        ...
        var i = this;
        i.last_idx = 1, i.segment_duration = 0, i.breakpoints = [], i.calculate_segment_info = function() {
            return t.duration / 1 === t.duration && r(i, _t.segment_info(t.duration))
        }, i.run = function() {
            if (i.segment_duration || i.calculate_segment_info()) {
                var e = _t.select_watched_segments(i, t);
                0 != e.length && t.emit(ct, {
                    position: e
                })
            }
        }, i.update = function() {
            i.calculate_segment_info(), _t.select_watched_segments(i, t)
        }
    }
    ...
    }, _t.select_watched_segments = function(e, t) {
        var n = e.last_idx || 1,
            r = Math.floor(t.currentTime / e.segment_duration);
        return e.last_idx = r, r < n ? [] : e.breakpoints.slice(n, r).map((function(t) {
    ...
    function yt(e, t, n) {
        ...
        r.last_tracked_ts = Date.now(), r.ticks = 0, r.run = function() {
            var e = Date.now();
            e - r.last_tracked_ts < 6e4 || (r.last_tracked_ts = e, ++r.ticks, t.emit(ct, {
                position: 60 * r.ticks
            }))
        }, r.update = function() {}
    }
    yt.within = function(e, t, n) {
        var r = e + t.right,
            i = e - t.left;
        return n < r && n > i
    };
    ...
    var Mt = Ie(Be(), (function(e, t, n) {
        if (ut.from_token(e.token).is_granted(ut.permissions.ANALYTICS) && !n.analytics) {
            var r = n.analytics = {
                    ticker: void 0,
                ...
                i = {
                    device_info: [rt.device, rt.os].join(","),
                    session_id: pt,
                    autoplay: n.autoplay,
                    muted: n.muted,
                    player_id: e.player_id
                },
                a = n.analytics.tracker = it.of(n, {
                    verb: it.verb.POST,
                    url: "https://ptm.flowplayer.com/:video_type/:sitegroup_id/:event_type",
                    events: bt,
                    required_keys: mt,
                    optional_keys: [].concat(ht).concat(vt),
                    metadata: i,
                    video_type: e.live ? "live" : "vod"
                });
            n.on("reap", (function() {
                a && a.destroy(), a = 0
            })), n.on(q, (function(t) {
                if (a) {
                    var i = o(t, "data.metadata", {});
                    if (i.media_id) {
                        var s = o(a, "metadata.media_id");
                        if (!s || i.media_id != s) {
                            var u = o(e, "analytics", {});
                            a.put(i), a.put(u), a.put({
                                video_type: e.live ? "live" : "vod",
                                source: e.source || St() || ""
                            }), r.ticker = e.live ? yt(r, n, a) : _t(r, n, a), r.ended = !1, n.emit(lt)
                        }
                    }
                }
            }));
            ...
            n.on("playing", (function() {
                if (a && !s && ! function(e, t) {
                    ...
                    if (e) return s = function(e, t, n) {
                        ...
                        r.last_media_id = a.metadata.media_id, n.emit(ft), n.emit(ct, {
                            position: [0]
                        }), s = void 0
                    }), (function() {
                        s = void 0
                ...
                if (a && !(s || wt(n) || r.ended)) return !e.live && n.currentTime >= Math.floor(n.duration) ? Et(r) : void r.comp.run()
        ...
        "undefined" != typeof window && "ontouchstart" in window && n.setState("is-touch-device", !0), n.setState("is-accessibility", !1), t.middle.on("touchend", (function(e) {
            ...
            setTimeout((function() {
                if (!e.defaultPrevented && !n.hasClass(R)) {
                    ...
                    var t = n.hasState(T);
                    r && clearTimeout(r), (t || n.hasState(L) || n.hasState("no-autoplay")) && (n.hasState(L) && (n.setState(L, !1), n.setState("is-hovered", !1)), n.togglePlay(), t) || (n.setState(L, !0), n.paused || (r = setTimeout((function() {
                        r = 0, n.setState(L, !1), n.setState("is-hovered", !1)
                    }), 2e3)))
                }
            }), 0)
        }))
    }
    Mt.Tracker = it, "undefined" != typeof window && window.matchMedia && [G, V].forEach((function(e) {
    ...
    function Pt(e, n) {
        ...
        return e.on("touchstart", (function(t) {
            t.target.closest(v(e)) && (e.touching = !0, h(e.parentElement) && (t.preventDefault(), e.grabbing = !0, l(d, e), s(d, e), m(t)))
        })), e.on("touchmove", (function(t) {
            t.target.closest(v(e)) && h(e.parentElement) && e.touching && (t.preventDefault(), m(t), c.call(d, p(t), e))
        })), e.on("touchend", (function(t) {
            setTimeout((function() {
                e.touching = !1, console.debug("Touching to false")
            }), 500), t.target.closest(v(e)) && h(e.parentElement) && (t.preventDefault(), e.grabbing = !1, f(d, e), u(d, e), i = 0)
        })), e.on("touchcancel", (function() {
            e.touching = !1, e.grabbing = !1, i = 0
        })), e.on("mousedown", (function(t) {
            e.touching || (Ot.on("mousemove", m), e.grabbing = !0, s.call(d, e), t.preventDefault(), m(t))
        })), e.on("mousemove", (function(t) {
            e.touching || c.call(d, p(t), e)
        })), Ot.on("mouseup", (function() {
            e.touching || (Ot.off("mousemove", m), e.grabbing = !1, u.call(d, e), i = 0)
        })), e
    }
    ...
    function xt(e) {
        var t, n, r = Nt("svg");
        return r.setAttribute("viewBox", e.coords), e.name && r.setAttribute("class", e.name), e.title && r.setAttribute("title", e.title), e.title && r.setAttribute("aria-label", e.title), r.setAttribute("tabindex", "0"), r.setAttribute("focusable", "true"), r.appendChild((t = e.link, (n = Nt("use")).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", t), n)), S(r)
    }
    var Rt = {
            coords: "-1 -2 40 30",
            name: "fp-fullscreen",
    ...
    function Ht(e, t, n) {
        if (e.controls) {
            var r = S.div("fp-volume"),
                i = Yt.call(n, r, Qt, e.rtl, n.root),
                o = S.div("fp-volumebtn", xt(jt));
            if (t.append(o), o && o.on(U, n.toggleMute), .1 == Wt.volume && t.append(r), r.attr("tabindex", "0").attr("role", "slider").attr("aria-valuemin", "0").attr("aria-valuemax", "1").attr("aria-label", n._t("core.volume", "volume")), e.muted_initially && Tt.setItem("mute", 1 == e.muted_initially), n.on("volumechange", (function() {
                    var e = 0 == n.volume || n.muted;
                    if (n.setState("is-muted", e), Tt.setItem("mute", e), o.attr("aria-label", e ? n._t("unmute", "unmute") : n._t("mute", "mute")), e) return i.adjust(0);
                    i.grabbing || i.adjust(n.volume)
                })), "true" == Tt.getItem("mute") && (n.muted = !0, n.setState("is-muted", n.muted)), e.muted_initially) return n.volume = 0, n.one("pause", (function() {
                n.volume = 1 * (Tt.getItem("volume") || 1), n.play()
            })), i;
            var a = Tt.getItem("volume");
            return a && !isNaN(a) && (n.volume = Number(a)), n.emit("volumechange"), i
        }
    }

    function Qt(e, t) {
        e > 0 && (this.muted = !1, Tt.removeItem("mute")), Tt.setItem("volume", this.volume = e / 100), t.adjust(this.volume)
    }

    function Yt(e, t, n, r) {
        var i = 10;
        return e.empty(), r.hasClass("is-small") && (i = 8), r.hasClass("is-tiny") && (i = 6), Pt(e, {
            onseek: t,
            ctx: this
        }), Xt(e, i), e
    }
    ...
    function Xt(e, t) {
        var n = Array.apply(null, Array(t)).map(Kt);
        return e.append(n), e.adjust = function(r) {
            e.attr("aria-valuenow", r);
            var i = (r *= 100) / 100,
                o = Math.round(i * t);
            n.slice(o, t).forEach(Kt.off), n.slice(0, o).forEach(Kt.on)
        }, e
    }

    function Jt(e, t, n) {
        n.toggleFullScreen = function(r, i) {
            n.ios_fullscreen_disabled || ("boolean" != typeof r && (r = !n.in_fullscreen), r != n.in_fullscreen && (n.in_fullscreen = r, n.emit(r ? "fullscreenenter" : "fullscreenexit"), n.emit("resize"), S.document.fullscreenEnabled && !e.fake_fullscreen && (r ? t.requestFullScreen() : S.document.exitFullScreen()), Zt() && (n.in_fullscreen ? function(e) {
                ...
                e.togglePlay(!1), n.hasClass(L) || n.addClass(L)
            }(n, i, t))))
    ...
    function $t(e, t, n) {
        var r = S.div("fp-header"),
            i = S.div("fp-primary"),
            a = S.div("fp-duration"),
            s = function(e, t) {
                var n = S.div("fp-secondary").addClass("fp-togglable");
                Jt(e, t.root, t);
                var r = xt(Rt).attr("role", "button").attr("aria-label", t._t("core.fullscreen")),
                    i = xt(Ft).attr("role", "button").attr("aria-label", t._t("core.fullscreen_exit"));
                return r.on(U, t.toggleFullScreen), i.on(U, t.toggleFullScreen), n.append([r, i]), n
            }(e, n),
            c = {
                logo: null
            };
        n.on(q, (function(e) {
            ...
            }(i, n, o(e, "data.logo_href")))
        })), r.append([i, a, s]), t.append(r), t.reaper.put("header", r), t.reaper.put("header.secondary", s)
    }
    Wt.volume = .1, Ht.inject_bar = Yt, Ht.Tick = Kt, Kt.on = function(e) {
            e.addClass("fp-color")
        }, Kt.off = function(e) {
            e.removeClass("fp-color")
        }, Ht.extend_volume_slider = Xt,
        function() {
            var e = S.document;
            if (e) {
                ...
                t.requestFullScreen || ["webkit", "moz", "ms"].forEach((function(n) {
                    var r = t[n + "RequestFullScreen"] || t.msRequestFullscreen,
                        i = e[n + "CancelFullScreen"] || e.msExitFullscreen;
                    r && (t.requestFullScreen = r, e.fullscreenEnabled = !0), i && (e.exitFullScreen = i)
    ...
    function tn(e, t, n) {
        var r = S.div("fp-middle");
        return n.root.reaper.put("middle", r),
            function(e, t) {
            ...
            function(e) {
                for (var t = S.div("fp-wait"), n = 0; n < 4; n++) t.append(S("<b>"));
                e.append(t)
            }(r), e.mouseover_play && n.root.on(["mouseenter", "mouseleave"], (function(e) {
                n.togglePlay("mouseenter" == e.type)
            })), en.forEach((function(e) {
                r.append(S.div("fp-switch", [Vt["PLAY_" + e], Vt["PAUSE_" + e]].map(nn)).addClass("fp-play-" + e))
    ...
    var rn = "function" == typeof requestAnimationFrame ? requestAnimationFrame : setTimeout;
    var on = S.div,
        an = S.span;

    function sn(e, t, n, r) {
        "function" == typeof n && (r = n, n = void 0), n = "string" == typeof n ? " " + n : "", r = r || on;
        var i = un(t);
        return e.put(t, r(i + n))
    }
    ...
    function ln(e, t) {
        var n = on("fp-controls fp-togglable"),
            r = J(n),
            i = sn(r, "timeline", un("bar")),
            o = sn(r, "btns", un("small-switch")),
            a = sn(r, "live-status"),
            s = sn(r, "live-indicator", un("color")),
            c = sn(r, "live-text").txt("live"),
            l = sn(r, "buffer"),
            f = sn(r, "progress", un("color")),
            d = sn(r, "hover"),
            p = sn(r, "timestamp"),
            m = sn(r, "duration"),
            v = sn(r, "elapsed", an).txt(u(0)),
            h = sn(r, "dragger", un("color")),
            g = cn.bind(null, t);
        i.attr("role", "slider").attr("tabindex", "0").attr("aria-label", t.translate("timeline", "Timeline")), i.append([l, f, d, p]), n.append([o, a, v, i, m]), a.append([s, c]), J(n);
        var _ = xt(g(Gt)).attr("role", "button"),
            y = xt(g(qt)).attr("role", "button");
        ...
        })), o.append([_, y]), f.append(h), e.append(n), n
    }
    ...
    var dn = Object.freeze({
        ...
        loadedmetadata: function(e, t, n) {
            t.duration && n.duration.txt(u(t.duration))
        },
        timeupdate: function(e, t, n) {
            n.elapsed.txt(u(t.currentTime))
        },
        ...
        timeline_grab_moved: function(e, t, n) {
            n.progress.css("width", e.percent + "%"), t.currentTime = t.duration * (e.percent / 100)
        },
        ...
        tooltip_update: function(e, t, n) {
            var r = e.percent,
                i = n.timestamp;
            !i || isNaN(r) || isNaN(t.duration) || (fn(n.timestamp, r), i.empty().append(S.span().txt(u(r / 100 * t.duration))))
        }
    });
    ...
    function mn(e) {
        ...
        if (!e.seekable.length) return {
            head: 0,
            tail: 0
        };
        var t = e.opts.live_dvr_window || 0,
    ...
    function vn(e, t) {
        var n = mn(e),
            r = t / 100 * (n.head - n.tail);
        return n.head - n.tail - r
    }

    function hn(e) {
        return e.opts.live_duration || e.duration
    }

    function gn(e) {
        return e.opts.live_rebuffer_budget || 10
    }

    function _n(e) {
        return e.opts.live_now || bn(e) - gn(e)
    }

    function yn(e) {
        var t = e.opts.live_dvr_window || 0;
        return e.opts.live_now ? e.opts.live_now - t : Math.max(0, mn(e).tail - t)
    }
    ...
    var Sn = Object.freeze({
        ...
        invert_percent: pn,
        seekable_range: mn,
        live_waypoint: function(e) {
            try {
                return e.currentTime - yn(e)
            } catch (t) {
                return console.error(t), e.currentTime
            }
        },
        seconds_in_past: function(e) {
            return e.currentTime - (vn(e, e.dvr_offset || 0) + gn(e))
        },
        time_watched: function(e) {
            var t = Date.now();
            return Math.round((t - (e.stream_start || t)) / 1e3)
        },
        seconds_from_head: vn,
        progress: function(e, t, n) {},
        timeupdate: function(e, t, n) {},
        loadedmetadata: function(e, t, n) {},
        timeline_repaint: function(e, t, n) {},
        tooltip_update: function(e, t, n) {
            if (!t.seeking) {
                var r = vn(t, e.percent);
                n.timestamp.txt("-" + u(r)), fn(n.timestamp, e.percent)
            }
        },
        ...
        buffer_update: function(e, t, n) {},
        timeline_grab_start: function(e, t, n) {},
        recover: function(e, t, n) {
            t.dvr_offset = 0, n.progress.css("width", 0), t.setState("is-live-seeked", !1)
        },
        timeline_grab_moved: function(e, t, n) {
            t.dvr_offset = e.percent;
            var r = pn(t.dvr_offset);
            n.progress.css("width", r + "%"), t.setState("is-live-seeked", r > 0);
            var i = mn(t),
                o = (i.head - i.tail) * (1 - t.dvr_offset / 100),
                a = i.head - o;
            t.currentTime = a
        },
        timeline_grab_end: function(e, t, n) {},
        timeline_mouse_move: function(e, t, n) {
            n.hover.css("width", pn(e.percent) + "%")
        },
        timeline_mouse_leave: function(e, t, n) {
            n.hover.css("width", 0), n.timestamp.hide()
        },
    ...
    function En(e) {
        ...
        this.route = function(n, r) {
            var i = (t[n] || {})[r.type];
            if (i) return i.apply(r.currentTarget, [r].concat(e, n));
            throw new Error("could not handle routed event of type (" + n + ":" + r.type + ")")
        }
    }

    function Mn(e, t, n) {
        if (e.controls) {
            var r = ln(t.ui, n.translator),
                i = t.reaper.put("timeline", r.timeline);
            t.reaper.put("controls", r);
            var a = En([n, r]);
            n.reaper.put("_behavior", a), Array.prototype.forEach.call(r.btns.childNodes, (function(e) {
                e.on(U, n.togglePlay)
                ...
                if (0 != n.reaper) {
                    var i;
                    if (h(n) || (i = o(t, "data.duration")), void 0 === o(t, "data.seekable") && (e.seekable = !0), isNaN(i) || i >= Number.MAX_SAFE_INTEGER) return r.duration.hide();
                    r.duration.show(), r.duration.txt(u(i))
                }
            }));
            var s, c, l, f, d, p, m = (s = function() {
                0 != n.reaper && (a.route(An(e), {
                    type: "timeline_repaint"
                }), n.paused || i && i.grabbing || requestAnimationFrame(m))
            }, c = setTimeout, l = 15 || 60, f = Math.ceil(1e3 / l), d = 0, p = null, function() {
                var e = Date.now() - d;
                null === p && (p = (c || rn)((function() {
                    p = null, s.apply(this, arguments), d = Date.now()
                }), f - e))
            });
            n.on("playing", m), n.paused || m(n, i), n.on("timeupdate", (function(t) {
                if (0 != n.reaper) {
                    var r = An(e);
                    i.attr("aria-valuenow", n.currentTime), a.route(r, t), a.route(r, {
                        type: "buffer_update"
                    }), m(n, i)
                }
                ...
                if (0 != n.reaper) {
                    ...
                    }(e) && wn(n, e.seconds_to_dvr || 0) && n.setOpts({
                        dvr: !0
                ...
                if (0 != n.reaper) {
                    ...
                    0 == n.reaper || isNaN(r) || (n.setOpts({
                        live: t,
                        duration: r
                    }), i.attr("aria-valuemax", r), i.attr("aria-valuemin", "0"))
                }
            ...
            Pt(i, {
                ...
                onstart: kn(n, (function() {
                    n.setState(N, !0), a.route(An(e), {
                        type: "timeline_grab_start"
                    })
                })),
                onend: function() {
                    if (n.disabled || 0 == e.seekable) return m();
                    n.setState(N, !1), a.route(An(e), {
        ...
        function h(e) {
            return o(e, "opts.live") || e.duration >= Number.MAX_SAFE_INTEGER
        }
    }
    ...
    function kn(e, t) {
        return function() {
            0 != o(e, "opts.seekable", !0) && (isNaN(e.duration) || e.disabled || t.apply(null, arguments))
        }
    }
    var On = {
    ...
    function Tn(e, n, r) {
        r.on("error", (function(e) {
            var i = e.data || r.error || {},
                o = r.togglePlay,
                a = e.code || i.code;
            console.error(i), setTimeout((function() {
                if (!e.defaultPrevented && "AbortError" != i.name) {
                    r.setState("is-error", !0), 8 != a && (r.togglePlay = t, r.one("recover", (function() {
                        r.togglePlay = o, r.setState("is-error", !1);
                        var e = n.find(".fp-error");
                        e && e.remove()
                    }))), 4 == a && r.one("loadstart", (function() {
                        r.emit("recover")
                    })), Pn(r.original_src) && "http:0" == i.code && (i.message = "attempted to load http content in an https context"), !1 === (navigator || {}).onLine && (i.code = 2, i.message = "Not connected to internet");
                    var s = function(e, t) {
                        if (t.message) return t.message;
                        if (t.stack) return t.stack;
                        var n = t.code || -1;
                        return e._t("media_errors." + n, On[n] || On[-1])
                    }(r, i);
                    return function(e, t, n, r) {
                        if (e) {
                            var i = S.div("fp-error").txt(t);
                            if (r) {
                                var o = e.querySelector("#" + r);
                                o && e.removeChild(o), i.id = r
                            }
                            e.append(i), n && i.append(S.div("fp-error-details").txt(n))
                        }
                    }(n.ui, s, i.details)
                }
            }))
    ...
    function xn(e, t, n) {
        setTimeout((function() {
            e.addClass(Nn[t]);
            for (var r = t; r < 4;) e.removeClass(Nn[r]), ++r;
            n && n()
        }), 400 - 66 * t)
    }
    ...
    function Rn(e, t) {
        var n = {
            ...
            i = JSON.stringify(n),
            o = "undefined" != typeof flowplayer && flowplayer.METERING_URL ? flowplayer.METERING_URL : "https://pmi.flowplayer.com/in";
        r.open("POST", o, !0), r.timeout = 2500, r.send(i), r.addEventListener("load", t.bind(null, r))
    }
    ...
    function Fn(e) {
        ...
        this.dictionaries = e, this.translate = function(e, t) {
            return void 0 === t && (t = ""),
                function e(t, n, r, i) {
                    return (i = i || 0) >= t.length ? r : o(t[i], n, e(t, n, r, i + 1))
    ...
    var Ln = {
        ...
        Cn = [].concat;
    var In = Ie(window, (function() {}));
    return In.onapi = function(e, t, n) {
            n.reaper.put("translator", new Fn(function(e, t) {
                var n = {};
                In[e.lang] && (n[e.lang] = In[e.lang]);
                (function() {
                    try {
                        return Cn.apply([], (navigator.languages || [navigator.language]).map((function(e) {
        ...
        function(e) {
            if ("undefined" == typeof document || ~Fe.indexOf(document.readyState)) return e();
        ...
        })), Ge(In, Mt, (function(e, t, n) {
            var r = document.createDocumentFragment(),
                i = S.div("fp-ui");
            J(i), r.appendChild(i), t.reaper.put("ui", i), ~t.className.indexOf("use-play-") || t.addClass("use-play-" + (e.play || 1)),
                function(e, t, n) {
                    var r = t.append(S.div({
                        class: "fp-footer"
                    }));
                    n.on(q, (function(e) {
                        var t = e.data,
                            n = t.description,
                            i = t.title;
                        if (r.empty(), "string" == typeof i && r.append(S.div({
                                class: "fp-title"
            ...
            0 != e.animation && "none" != e.preload && (t.addClass(Nn[3]), n.on("loadstart", (function() {
                xn(t, 2)
            })), n.on(D, (function() {
                xn(t, 1)
            ...
            [At, kt].forEach((function(r) {
                r(e, t, n)
            }))
        }), (function(e, t, n) {
            if (!ut.from_token(e.token).is_granted(ut.permissions.NO_METERING)) {
                var r = qe.id(e.token);
                if (r) {
                    var i = Rn.bind(null, r, (function(e) {
        ...
        })), Ge.volume = Ht, Ge.storage = Tt, Ge.i18n = In, Ge.ui = zt, Ge
}));
